...
export const EVENT_SCORE_TABLES = {
  ...
  kvk: {
    ...
    epic_general_shard: 1220,
    mythic_general_shard: 3040,
    troops: { 1: 3, 2: 4, 3: 5, 4: 8, 5: 12, 6: 18, 7: 25, 8: 35, 9: 45, 10: 60, 11: 75 },
    gov_gear_score: 36,
    gov_charm_score: 70,
    pet_advancement: 50,
    satin: 1,
  ...
  ab: {
    ...
    troops: { 1: 1, 2: 1, 3: 2, 4: 3, 5: 4, 6: 7, 7: 10, 8: 14, 9: 18, 10: 24, 11: 30 },
    gov_gear_score: 22,
    gov_charm_score: 45,
    pet_advancement: 30,
    satin: 1,
...
export const VAULT_COMMON_IDS = [
  'bread', 'wood', 'stone', 'iron', 'gold',
  'truegold', 'truegold_dust', 'tempered_truegold',
  'hero_xp', 'stamina',
  'master_manuscript', 'general_emblem',
  'promotion_medallion', 'nutrient_potion', 'growth_manual',
  'advanced_taming_mark', 'common_taming_mark', 'pet_food',
  'charm_design', 'charm_guide',
  'mithril', 'forge_hammer', 'widgets',
  'building_speedup', 'research_speedup', 'training_speedup',
  'master_speedup', 'general_speedup',
  'rare_general_shard', 'epic_general_shard', 'mythic_general_shard',
  'hero_roulette_token',
];
...
export const VAULT_EVENT_EXTRA = {
  sg: [],
  kvk: [
    { id: 'intel_missions', label: 'Intel Missions completed', placeholder: '0', misc: true },
  ],
  ab: [
    // gems already in common RESOURCE_ITEMS; scored on Misc via SCORE_RULES.gem
    { id: 'topup_points', label: 'Top-up points obtained', placeholder: '0', misc: true },
    { id: 'escort_trucks', label: 'Escort Truck runs', placeholder: '0', misc: true },
    { id: 'raid_trucks', label: 'Raid Truck runs', placeholder: '0', misc: true },
    { id: 'intel_missions', label: 'Intel Missions completed', placeholder: '0', misc: true },
    { id: 'beast_1_10', label: 'Beasts Lv1–10 defeated', placeholder: '0', misc: true },
    { id: 'beast_11_15', label: 'Beasts Lv11–15 defeated', placeholder: '0', misc: true },
    { id: 'beast_16_20', label: 'Beasts Lv16–20 defeated', placeholder: '0', misc: true },
    { id: 'beast_21_25', label: 'Beasts Lv21–25 defeated', placeholder: '0', misc: true },
    { id: 'beast_26_30', label: 'Beasts Lv26–30 defeated', placeholder: '0', misc: true },
    { id: 'terror_rallies', label: 'Terror rallies completed', placeholder: '0', misc: true },
  ],
};
...
export function getGatherRate(eventId, resourceType) {
  ...
  if (t === 'bread' || t === 'wood') {
    return { rate: rules.gather_bread_wood_pts || 3, per: rules.gather_bread_wood_per || 2500 };
  }
  if (t === 'stone') {
    return { rate: rules.gather_stone_pts || 3, per: rules.gather_stone_per || 500 };
  }
  if (t === 'iron') {
    return { rate: rules.gather_iron_pts || 3, per: rules.gather_iron_per || 100 };
  }
  return { rate: 3, per: 2500 };
}
